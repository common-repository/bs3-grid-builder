...
Tags: responsive grid builder, bootstrap, grid maker, page composer, grid content, multiple columns, drag and drop, page builder
...
Bootstrap Grid Builder is a powerful WordPress plugin for designing and prototyping modern websites.
...
== Screenshots ==
1. Bootstrap 3 grid builder (back-end).
2. Portability menu - Import and Export previously created layout.
3. Ability to add additional in page JavaScript code.
4. Ability to add additional in page CSS code.
5. Row settings.
6. Column settings.
7. Final results (front-end).
8. Custom blockquote within citation and citation link support.
